...
<!--
    Document   : 07.xsl
    Created on : 11 de mayo de 2021, 12:34
    Author     : daw1
    Description:
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title>07 XSLT Test SINF - VictorBlancoRodrigo</title>
            </head>
            <body>
                <h1>
                ...
                <h3>
                    <xsl:value-of select="concat('Fecha: ',//dia,' de ',document('meses.xml')//mes[@id=current()//mes],' de ',//anyo)"/>
                </h3>
